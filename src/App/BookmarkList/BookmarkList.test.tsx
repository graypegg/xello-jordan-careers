...
const onChangeCareerMock = (_: ICareer) => {/* void */}
...
it('renders without crashing', () => {
  shallow(<BookmarkList bookmarks={[]} onChange={onChangeMock} onChangeCareer={onChangeCareerMock} />)
})

it('renders a single bookmark', () => {
  const wrapper = shallow(<BookmarkList bookmarks={bookmarks} onChange={onChangeMock} onChangeCareer={onChangeCareerMock} />)
...
it('fires onChange when deleting a bookmark', () => {
  ...
  const wrapper = shallow(<BookmarkList bookmarks={bookmarks} onChange={onChangeMockSpied} onChangeCareer={onChangeCareerMock} />)
